...
class TestQueueManagerQueueNewRecipe(TransactionTestCase):
    ...
    def test_successful_ingest(self, mock_msg_mgr):
        ...
        created_strike_recipe = Queue.objects.queue_new_recipe_ingest_v6(recipetype1, data._new_data, strike_event, recipe_config=config)
        ...
        data = JobDataV6(data_dict)
        created_scan_recipe = Queue.objects.queue_new_recipe_ingest_v6(recipetype1, data._new_data, scan_event, recipe_config=config)
