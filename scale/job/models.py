...
class JobExecutionEnd(models.Model):
    ...
    :keyword started: When the job execution was started (scheduled)
    :type started: :class:`django.db.models.DateTimeField`
    :keyword alg_started: When the algorithm was started (main task)
    :type alg_started: :class:`django.db.models.DateTimeField`
    :keyword alg_ended: When the algorithm ended (main task)
    :type alg_ended: :class:`django.db.models.DateTimeField`
    ...
    alg_started = models.DateTimeField(blank=True, null=True)
    alg_ended = models.DateTimeField(blank=True, null=True)
