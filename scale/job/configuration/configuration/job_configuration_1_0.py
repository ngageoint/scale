...
from job.configuration.configuration.job_parameter import DockerParam, TaskWorkspace
...
class JobConfiguration(object):
    ...
    def get_job_task_workspaces(self):
        ...
        :rtype: [:class:`job.configuration.configuration.job_parameter.TaskWorkspace`]
        """
    ...
    def _get_workspace_docker_params(self, framework_id, job_exe_id, task_workspaces, workspaces, volume_create):
        ...
        :type task_workspaces: [:class:`job.configuration.configuration.job_parameter.TaskWorkspace`]
        :param workspaces: A dict of all workspaces stored by name
        :type workspaces: {string: :class:`storage.models.Workspace`}
