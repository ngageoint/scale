...
class JobConfiguration(object):
    ...
    # TODO: Remove method when non-seed jobs no longer need to be supported
    def validate_old(self, interface_dict):
        """Validates the configuration against old interface to find setting and mount usages
