...
class AbstractDataFileStore(object):
    ...
    def store_files(self, upload_dir, work_dir, data_files, input_file_ids, job_exe):
        ...
        :type work_dir: str
        :param data_files: Dict with workspace ID mapping to a list of tuples with file paths relative to the upload
            directory and media type (media type is optionally None)
