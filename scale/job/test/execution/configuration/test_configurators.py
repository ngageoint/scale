...
class TestQueuedExecutionConfigurator(TestCase):
    ...
    #     #              'output_data': []}
    #     data_dict = {'version': '6', 'files': {'input_2': [file_1.id], 'input_2': [file_2.id, file_3.id]},
    #             'json': {'input_1': 'my_val'}}
    ...
    #                   {'name': 'input_4', 'mediaTypes': ['text/plain'], 'multiple': True}]
    #     inputs_json = [{'name': 'input_1', 'type': 'string'}]
    #     outputs_files = [{'name': 'output_1', 'mediaType': 'text/plain', 'pattern': '*_.txt'}]
    #     manifest = job_test_utils.create_seed_manifest(command='foo ${-a INPUT_1} ${-b INPUT_2} ${INPUT_3} ${INPUT_4} ${JOB_OUPTPUT_DIR}',
