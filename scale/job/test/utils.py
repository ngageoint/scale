...
def edit_job_type_v6(job_type, manifest_dict=None, docker_image=None, icon_code=None, is_active=None, 
    ...
    """
    JobType.objects.edit_job_type_v6(job_type.id, manifest_dict=manifest_dict, docker_image=docker_image, 
                         icon_code=icon_code, is_active=is_active, is_paused=is_paused, 
                         max_scheduled=max_scheduled, configuration_dict=configuration_dict)
