...
class TestCreateRecipes(TestCase):
    ...
    def test_execute_entire_reprocess(self):
        ...
        recipe_a_1 = recipe_test_utils.create_recipe(recipe_type=recipe_type_a, input=input_data_dict)
        recipe_a_2 = recipe_test_utils.create_recipe(recipe_type=recipe_type_a, input=input_data_dict)
        node_e_1 = recipe_test_utils.create_recipe_node(recipe=recipe_a_1, node_name='recipe_e')
        node_e_2 = recipe_test_utils.create_recipe_node(recipe=recipe_a_2, node_name='recipe_e')
        node_d_1 = recipe_test_utils.create_recipe_node(recipe=recipe_a_1, node_name='recipe_d')
        node_d_2 = recipe_test_utils.create_recipe_node(recipe=recipe_a_2, node_name='recipe_d')
        RecipeNode.objects.bulk_create([node_e_1, node_e_2, node_d_1, node_d_2])
        node_b_1 = recipe_test_utils.create_recipe_node(recipe=recipe_a_1, node_name='recipe_b')
        node_b_2 = recipe_test_utils.create_recipe_node(recipe=recipe_a_2, node_name='recipe_b')
        RecipeNode.objects.bulk_create([node_b_1, node_b_2])
        recipe_b_1 = recipe_test_utils.create_recipe(recipe_type=recipe_type_b, parent_recipe=recipe_a_1, recipe_node=node_b_1)
        recipe_b_2 = recipe_test_utils.create_recipe(recipe_type=recipe_type_b, parent_recipe=recipe_a_2, recipe_node=node_b_2)
        node_c_1 = recipe_test_utils.create_recipe_node(recipe=recipe_b_1, node_name='recipe_c')
        node_c_2 = recipe_test_utils.create_recipe_node(recipe=recipe_b_2, node_name='recipe_c')
        RecipeNode.objects.bulk_create([node_c_1, node_c_2])
        recipe_c_1 = recipe_test_utils.create_recipe(recipe_type=recipe_type_c, parent_recipe=recipe_b_1, recipe_node=node_c_1)
        recipe_c_2 = recipe_test_utils.create_recipe(recipe_type=recipe_type_c, parent_recipe=recipe_b_2, recipe_node=node_c_2)
        recipe_d_1 = recipe_test_utils.create_recipe(recipe_type=recipe_type_d, parent_recipe=recipe_a_1, recipe_node=node_d_1)
        recipe_d_2 = recipe_test_utils.create_recipe(recipe_type=recipe_type_d, parent_recipe=recipe_a_2, recipe_node=node_d_2)
        recipe_e_1 = recipe_test_utils.create_recipe(recipe_type=recipe_type_e, parent_recipe=recipe_a_1, recipe_node=node_e_1)
        recipe_e_2 = recipe_test_utils.create_recipe(recipe_type=recipe_type_e, parent_recipe=recipe_a_2, recipe_node=node_e_2)

        node_a_x_1 = recipe_test_utils.create_recipe_node(recipe=recipe_a_1, node_name='job_a_x')
        node_b_x_1 = recipe_test_utils.create_recipe_node(recipe=recipe_b_1, node_name='job_b_x')
        node_b_x_2 = recipe_test_utils.create_recipe_node(recipe=recipe_b_2, node_name='job_b_x')
        node_b_y_1 = recipe_test_utils.create_recipe_node(recipe=recipe_b_1, node_name='job_b_y')
        node_a_x_2 = recipe_test_utils.create_recipe_node(recipe=recipe_a_2, node_name='job_a_x')
        node_b_y_2 = recipe_test_utils.create_recipe_node(recipe=recipe_b_2, node_name='job_b_y')
        node_b_z_1 = recipe_test_utils.create_recipe_node(recipe=recipe_b_1, node_name='job_b_z')
        node_b_z_2 = recipe_test_utils.create_recipe_node(recipe=recipe_b_2, node_name='job_b_z')
        node_c_x_1 = recipe_test_utils.create_recipe_node(recipe=recipe_c_1, node_name='job_c_x')
        node_c_x_2 = recipe_test_utils.create_recipe_node(recipe=recipe_c_2, node_name='job_c_x')
        node_c_y_1 = recipe_test_utils.create_recipe_node(recipe=recipe_c_1, node_name='job_c_y')
        node_c_y_2 = recipe_test_utils.create_recipe_node(recipe=recipe_c_2, node_name='job_c_y')
        node_c_z_1 = recipe_test_utils.create_recipe_node(recipe=recipe_c_1, node_name='job_c_z')
        node_c_z_2 = recipe_test_utils.create_recipe_node(recipe=recipe_c_2, node_name='job_c_z')
        node_d_x_1 = recipe_test_utils.create_recipe_node(recipe=recipe_d_1, node_name='job_d_x')
        node_d_x_2 = recipe_test_utils.create_recipe_node(recipe=recipe_d_2, node_name='job_d_x')
        node_d_y_1 = recipe_test_utils.create_recipe_node(recipe=recipe_d_1, node_name='job_d_y')
        node_d_y_2 = recipe_test_utils.create_recipe_node(recipe=recipe_d_2, node_name='job_d_y')
        node_d_z_1 = recipe_test_utils.create_recipe_node(recipe=recipe_d_1, node_name='job_d_z')
        node_d_z_2 = recipe_test_utils.create_recipe_node(recipe=recipe_d_2, node_name='job_d_z')
        node_e_x_1 = recipe_test_utils.create_recipe_node(recipe=recipe_e_1, node_name='job_e_x')
        node_e_x_2 = recipe_test_utils.create_recipe_node(recipe=recipe_e_2, node_name='job_e_x')
        node_e_y_1 = recipe_test_utils.create_recipe_node(recipe=recipe_e_1, node_name='job_e_y')
        node_e_y_2 = recipe_test_utils.create_recipe_node(recipe=recipe_e_2, node_name='job_e_y')
        ...
        job_a_x_1 = job_test_utils.create_job(job_type=job_type_a_x, save=False, recipe=recipe_a_1, recipe_node=node_a_x_1)
        job_a_x_2 = job_test_utils.create_job(job_type=job_type_a_x, save=False, recipe=recipe_a_2, recipe_node=node_a_x_2)
        job_b_x_1 = job_test_utils.create_job(job_type=job_type_b_x, save=False, recipe=recipe_b_1, recipe_node=node_b_x_1)
        job_b_x_2 = job_test_utils.create_job(job_type=job_type_b_x, save=False, recipe=recipe_b_2, recipe_node=node_b_x_2)
        job_b_y_1 = job_test_utils.create_job(job_type=job_type_b_y, save=False, recipe=recipe_b_1, recipe_node=node_b_y_1)
        job_b_y_2 = job_test_utils.create_job(job_type=job_type_b_y, save=False, recipe=recipe_b_2, recipe_node=node_b_y_2)
        job_b_z_1 = job_test_utils.create_job(job_type=job_type_b_z, save=False, recipe=recipe_b_1, recipe_node=node_b_z_1)
        job_b_z_2 = job_test_utils.create_job(job_type=job_type_b_z, save=False, recipe=recipe_b_2, recipe_node=node_b_z_2)
        job_c_x_1 = job_test_utils.create_job(job_type=job_type_c_x, save=False, recipe=recipe_c_1, recipe_node=node_c_x_1)
        job_c_x_2 = job_test_utils.create_job(job_type=job_type_c_x, save=False, recipe=recipe_c_2, recipe_node=node_c_x_2)
        job_c_y_1 = job_test_utils.create_job(job_type=job_type_c_y, save=False, recipe=recipe_c_1, recipe_node=node_c_y_1)
        job_c_y_2 = job_test_utils.create_job(job_type=job_type_c_y, save=False, recipe=recipe_c_2, recipe_node=node_c_y_2)
        job_c_z_1 = job_test_utils.create_job(job_type=job_type_c_z, save=False, recipe=recipe_c_1, recipe_node=node_c_z_1)
        job_c_z_2 = job_test_utils.create_job(job_type=job_type_c_z, save=False, recipe=recipe_c_2, recipe_node=node_c_z_2)
        job_d_x_1 = job_test_utils.create_job(job_type=job_type_d_x, save=False, recipe=recipe_d_1, recipe_node=node_d_x_1)
        job_d_x_2 = job_test_utils.create_job(job_type=job_type_d_x, save=False, recipe=recipe_d_2, recipe_node=node_d_x_2)
        job_d_y_1 = job_test_utils.create_job(job_type=job_type_d_y, save=False, recipe=recipe_d_1, recipe_node=node_d_y_1)
        job_d_y_2 = job_test_utils.create_job(job_type=job_type_d_y, save=False, recipe=recipe_d_2, recipe_node=node_d_y_2)
        job_d_z_1 = job_test_utils.create_job(job_type=job_type_d_z, save=False, recipe=recipe_d_1, recipe_node=node_d_z_1)
        job_d_z_2 = job_test_utils.create_job(job_type=job_type_d_z, save=False, recipe=recipe_d_2, recipe_node=node_d_z_2)
        job_e_x_1 = job_test_utils.create_job(job_type=job_type_e_x, save=False, recipe=recipe_e_1, recipe_node=node_e_x_1)
        job_e_x_2 = job_test_utils.create_job(job_type=job_type_e_x, save=False, recipe=recipe_e_2, recipe_node=node_e_x_2)
        job_e_y_1 = job_test_utils.create_job(job_type=job_type_e_y, save=False, recipe=recipe_e_1, recipe_node=node_e_y_1)
        job_e_y_2 = job_test_utils.create_job(job_type=job_type_e_y, save=False, recipe=recipe_e_2, recipe_node=node_e_y_2)
    ...
    def test_execute_reprocess(self):
        ...
        input_1_dict = convert_data_to_v6_json(input_1).get_dict()
        recipe_1 = recipe_test_utils.create_recipe(recipe_type=recipe_type, input=input_1_dict)
        node_1 = recipe_test_utils.create_recipe_node(recipe=recipe_1, node_name='Job 1')
        node_2 = recipe_test_utils.create_recipe_node(recipe=recipe_1, node_name='Job 2')
        job_1_1 = job_test_utils.create_job(job_type=job_type_1, status='COMPLETED', recipe=recipe_1, recipe_node=node_1)
        job_1_2 = job_test_utils.create_job(job_type=job_type_2, status='COMPLETED', recipe=recipe_1, recipe_node=node_2)

        input_2 = Data()
        input_2.add_value(FileValue('Recipe Input', [file_2.id]))
        input_2_dict = convert_data_to_v6_json(input_2).get_dict()
        recipe_2 = recipe_test_utils.create_recipe(recipe_type=recipe_type, input=input_2_dict)
        node_1 = recipe_test_utils.create_recipe_node(recipe=recipe_2, node_name='Job 1')
        node_2 = recipe_test_utils.create_recipe_node(recipe=recipe_2, node_name='Job 2')
        job_2_1 = job_test_utils.create_job(job_type=job_type_1, status='COMPLETED', recipe=recipe_2, recipe_node=node_1)
        job_2_2 = job_test_utils.create_job(job_type=job_type_2, status='COMPLETED', recipe=recipe_2, recipe_node=node_2)
        ...
        for recipe_node in recipe_nodes:
            if recipe_node.recipe_id == new_recipe_1.id:
                self.assertEqual(recipe_node.id, job_1_1.recipe_node.id)
            elif recipe_node.recipe_id == new_recipe_2.id:
                self.assertEqual(recipe_node.id, job_2_1.recipe_node.id)
            self.assertFalse(recipe_node.is_original)
