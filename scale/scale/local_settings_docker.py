...
FLUENTD_BUFFER_WARN = os.environ.get('FLUENTD_BUFFER_WARN', FLUENTD_BUFFER_WARN)
FLUENTD_BUFFER_SIZE_WARN = os.environ.get('FLUENTD_BUFFER_SIZE_WARN', FLUENTD_BUFFER_SIZE_WARN)
