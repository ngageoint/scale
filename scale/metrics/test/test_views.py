...
class TestMetricDetailsViewV5(TransactionTestCase):
...
class TestMetricPlotViewV5(TransactionTestCase):
    ...
    def test_successful(self):
        ...
        url = '/v5/metrics/job-types/plot-data/'
        response = self.client.generic('GET', url)
        self.assertEqual(response.status_code, status.HTTP_200_OK, response.content)
    ...
    def test_choices(self):
        ...
        url = '/v5/metrics/job-types/plot-data/?choice_id=%s&choice_id=%s' % (self.job_type1.id, self.job_type2.id)
        response = self.client.generic('GET', url)
        self.assertEqual(response.status_code, status.HTTP_200_OK, response.content)
    ...
    def test_columns(self):
        ...
        url = '/v5/metrics/job-types/plot-data/?column=completed_count&column=failed_count'
        response = self.client.generic('GET', url)
        self.assertEqual(response.status_code, status.HTTP_200_OK, response.content)
    ...
    def test_groups(self):
        ...
        url = '/v5/metrics/job-types/plot-data/?group=overview'
        response = self.client.generic('GET', url)
        self.assertEqual(response.status_code, status.HTTP_200_OK, response.content)
    ...
    def test_aggregate_sum(self):
        ...
        url = '/v5/metrics/job-types/plot-data/?column=job_time_sum'
        response = self.client.generic('GET', url)
        self.assertEqual(response.status_code, status.HTTP_200_OK, response.content)
    ...
    def test_aggregate_min(self):
        ...
        url = '/v5/metrics/job-types/plot-data/?column=job_time_min'
        response = self.client.generic('GET', url)
        self.assertEqual(response.status_code, status.HTTP_200_OK, response.content)
    ...
    def test_aggregate_max(self):
        ...
        url = '/v5/metrics/job-types/plot-data/?column=job_time_max'
        response = self.client.generic('GET', url)
        self.assertEqual(response.status_code, status.HTTP_200_OK, response.content)
    ...
    def test_aggregate_avg(self):
        ...
        url = '/v5/metrics/job-types/plot-data/?column=job_time_avg'
        response = self.client.generic('GET', url)
        self.assertEqual(response.status_code, status.HTTP_200_OK, response.content)
