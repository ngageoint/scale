...
class ScaleFile(models.Model):
    ...
    recipe_id = models.CharField(null=True, blank=True, max_length=250, db_index=True)
    ...
    batch_id = models.CharField(null=True, blank=True, max_length=250, db_index=True)
