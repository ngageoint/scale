...
| **Get Queue Depth**                                                                                                     |
+=========================================================================================================================+
| Returns the queue depth (total, split by job type, and split by priority level) statistics within the given time range. |
...
| **JSON Fields**                                                                                                         |
+--------------------+-------------------+--------------------------------------------------------------------------------+
| job_types          | List              | The list of job types with a non-zero queue depth in the time range, with each |
|                    |                   | type's ID, name, and version                                                   |
+--------------------+-------------------+--------------------------------------------------------------------------------+
| priorities         | List              | The list of priority levels with a non-zero queue depth in the time range      |
+--------------------+-------------------+--------------------------------------------------------------------------------+
| queue_depths       | List              | The list of points within the time range where the queue depth was measured    |
+--------------------+-------------------+--------------------------------------------------------------------------------+
| time               | ISO-8601 Datetime | The time that the queue depth was measured                                     |
+--------------------+-------------------+--------------------------------------------------------------------------------+
| total_depth        | Integer           | The total queue depth at this point                                            |
+--------------------+-------------------+--------------------------------------------------------------------------------+
| depth_per_job_type | List              | The list of queue depths for each job type. Each depth corresponds to the job  |
|                    |                   | type with the same index in the *job_types* list.                              |
+--------------------+-------------------+--------------------------------------------------------------------------------+
| depth_per_priority | List              | The list of queue depths for each priority. Each depth corresponds to the      |
|                    |                   | priority with the same index in the *priorities* list.                         |
+--------------------+-------------------+--------------------------------------------------------------------------------+
| .. code-block:: javascript                                                                                              |
|                                                                                                                         |
|    {                                                                                                                    |
...
|                "total_depth": 25,                                                                                       |
|                "depth_per_job_type": [19, 6],                                                                           |
|                "depth_per_priority": [11, 14],                                                                          |
|            },                                                                                                           |
|            ...                                                                                                          |
|        ]                                                                                                                |
|    }                                                                                                                    |
