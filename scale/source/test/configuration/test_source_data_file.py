...
class TestSourceDataFileParseSaverSaveParseResults(TestCase):
    ...
    def setUp(self):
        ...
        self.workspace = Workspace.objects.create(name=u'Test workspace')
        ...
        self.source_file_1 = SourceFile.objects.create(file_name=self.file_name_1, media_type=self.media_type_1, file_size=10,
                                                       data_type=u'Dummy', file_path=u'the_path', workspace=self.workspace)
        self.file_name_2 = u'my_file.json'
        self.media_type_2 = u'application/json'
