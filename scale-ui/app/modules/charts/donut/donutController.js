                ...
                chart = c3.generate({
                    ...
                    data: {
                        ...
                        colors: {
                            ...
                            Done: '#3681bf',
                            Ready: scaleConfig.colors.chart_green,
                            Deprecated: scaleConfig.colors.chart_gray_dark,
                            Offline: scaleConfig.colors.failure_system,
                            'Scheduler Stopped': scaleConfig.colors.chart_orange,
                            Degraded: scaleConfig.colors.chart_red,
                            'Initial Cleanup': scaleConfig.colors.chart_blue,
                            'Image Pull': scaleConfig.colors.chart_purple,
